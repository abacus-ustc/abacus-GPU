...
/* Subroutine */int pdlascl(char *type__, int *kl, int *ku, double *cfrom,
	...
	*info = 0;
	...
	if (plsame(type__, "G")) {
		itype = 0;
	} else if (plsame(type__, "L")) {
		itype = 1;
	} else if (plsame(type__, "U")) {
		itype = 2;
	} else if (plsame(type__, "H")) {
		itype = 3;
	} else if (plsame(type__, "B")) {
		itype = 4;
	} else if (plsame(type__, "Q")) {
		itype = 5;
	} else if (plsame(type__, "Z")) {
		itype = 6;
	} else {
		itype = -1;
	}
